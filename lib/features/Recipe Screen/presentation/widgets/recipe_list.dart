  ...
  Widget build(BuildContext context, ref) {
    ...
    return Scaffold(
      ...
      body: recipeProvider.when(
        data: (recipes) {
          return mainBody(recipes,loading: false);
        },
        error: (error, stackTrace) => Container(
          child: Text(error.toString()),
        ),
        loading: () =>AbsorbPointer(
                child: mainBody(RecipeModel(), loading: true))
      ),
    );
  }

  Column mainBody(RecipeModel recipes,{bool loading=true}) {
    return Column(
                    ...
                    Container(
                      ...
                      child: Consumer(builder: (context, ref, child) {
                        ...
                        final sortController =
                            ref.read(sortProvider.notifier);
                ...
                :DropdownMenu(
                    ...
                    Container(
                      ...
                      child: Consumer(builder: (context, ref, child) {
                        ...
                        final intolerances =
                            intoleranceController.intolerances;
                        return loading
                ? ShimmerBox(height: 40)
                :DropdownMenu(
                            menuHeight: 200,
                            ...
                            onSelected: (value) => intoleranceController
                                .selectIntolerance(value!),
